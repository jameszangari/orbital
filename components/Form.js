  ...
  return (
    <div className="form-container">
      <form onSubmit={handleSubmit} className="w-full">
        ...
        <div className="block w-full my-3 mx-auto">
          <label className="block">Create Planet Name</label>
          <input
            type="text"
            name="title"
        ...
        <div className="block w-full my-3 mx-auto">
          <label className="block">Choose Planet Type</label>
          <div className="flex">
        ...
        <div className="block w-full my-3 mx-auto">
          <label className="block text-xl font">Choose Planet Core</label>
          <div className="flex">
